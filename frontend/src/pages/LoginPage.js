    ...
    <div className="auth-root" data-auth-theme={theme}>
      ...
      <div className="auth-card">
        ...
        <p className="auth-legal">
          By signing in, you agree to our <a href="/terms">Terms</a> and <a href="/privacy-policy">Privacy Policy</a>
        </p>
      </div>
      ...
      <style>{`
        ...
        .orb-a { width: 520px; height: 520px; background: #4f8ef7; top: -180px; left: -180px; animation-delay: 0s; }
        .orb-b { width: 380px; height: 380px; background: #a78bfa; bottom: -120px; right: -100px; animation-delay: -3s; }
        .orb-c { width: 280px; height: 280px; background: #34d399; top: 55%; left: 55%; animation-delay: -5s; opacity: var(--auth-particle-opacity); }
        .bg-grid {
        ...
        .brand-accent { color: #4f8ef7; }

        /* Headings */
        .auth-top { margin-bottom: 1.75rem; }
        .auth-heading {
          font-family: 'Syne', sans-serif;
          font-size: 1.65rem; font-weight: 800;
          color: var(--auth-input-color); margin-bottom: 0.3rem; line-height: 1.2;
        }
        ...
        .field-icon {
          ...
          font-size: 0.9rem; color: var(--auth-label); pointer-events: none; z-index: 1;
        }
        .field-input {
          width: 100%;
          ...
          color: var(--auth-input-color); font-size: 0.9rem;
          font-family: 'DM Sans', sans-serif;
        ...
        .pass-toggle {
          ...
          font-size: 0.9rem; color: var(--auth-label);
          transition: color 0.2s ease; padding: 0.25rem;
        }
        ...
        .auth-divider span { font-size: 0.75rem; color: var(--auth-placeholder); }

        /* Switch & legal */
        .auth-switch {
          text-align: center; font-size: 0.875rem; color: var(--auth-sub);
        }
        .auth-switch a { color: #4f8ef7; font-weight: 600; }
        .auth-switch a:hover { text-decoration: underline; }
        .auth-legal {
          text-align: center; font-size: 0.72rem;
          color: var(--auth-placeholder); margin-top: 1rem; line-height: 1.5;
        }
        ...
        [data-auth-theme="light"] .auth-card {
          ...
          box-shadow: 0 24px 80px rgba(0,0,0,0.12), 0 0 40px rgba(79,142,247,0.1) !important;
        }
        ...
        [data-auth-theme="light"] .bg-grid {
          background-image: linear-gradient(rgba(79,142,247,0.08) 1px, transparent 1px),
                            linear-gradient(90deg, rgba(79,142,247,0.08) 1px, transparent 1px) !important;
        }
      `}</style>
    </div>
  );
